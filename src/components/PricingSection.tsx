...
const packages = [
  {
    name: "Starter",
    subtitle: "Digitale Basis & Roadmap",
    description: "Professionele website & strategische nulmeting.",
    price: "Vanaf € 1.850",
    monthlyPrice: "€ 50",
    features: [
  ...
  },
  {
    ...
    features: [
      "Alles uit Starter +",
      "Facturatie & E-invoicing koppeling",
      "Geautomatiseerde afspraakplanning",
      "Basis e-mail automation & CRM",
    ],
    highlighted: true,
  },
  {
    ...
    description: "Volledig ontzorgd met AI workflows.",
    price: "Op aanvraag",
    monthlyPrice: "Maatwerk retainer",
    features: [
      "Alles uit Business +",
      "Custom Portals & Dashboards",
      "AI-gedreven proces automatisering",
